...
$sql = "SELECT * FROM administrators WHERE AdminID='$user_id'";
    ...
    <div class="header-container">
        ...
        <nav>
            <ul>
                ...
                <li><a href="redact.php">редакция</a></li>
                <li><a href="logout1.php">Выйти</a></li>
            </ul>
        </nav>
    </div>
</header>
<div class="container">
    ...
    <div class="buttons">
        ...
        <form id="uploadPhotoForm" action="upload_photo1.php" method="post" enctype="multipart/form-data" style="display: none;">
