...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result) {
        ...
        header("Location: admin_profile.php"); // Перенаправление на страницу профиля
        exit();
    } else {
    ...
    header("Location: admin_auth.php"); // Перенаправляем, если данные не отправлены методом POST
    exit();
}
?>
